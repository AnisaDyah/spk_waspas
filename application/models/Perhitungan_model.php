<?php
    ...
    class Perhitungan_model extends CI_Model {
        ...
        {
            $query = $this->db->query("SELECT * FROM data_naker WHERE status='aktif';");
            return $query->result();
        }
    ...
    public function get_jenis_nilai($id_user,$id_naker,$id_kriteria)
	{
    ...
    WHERE penilaian.id_user='$id_user' AND penilaian.id_naker='$id_naker'  AND penilaian.id_kriteria='$id_kriteria';");
    return $query->row_array();
    }
    ...
    public function hasil($id_naker)
	{
		$query = $this->db->query("SELECT * FROM data_naker WHERE id_naker='$id_naker';");
		return $query->row_array();		
    }
    ...
    //menyimpan, mengubah db hasil keputusan
        ...
        {
            $query = $this->db->simple_query("UPDATE hasil_keputusan SET hasil='$id_naker' WHERE id_user='$id_user' ;");
            return $result;	
        }

        public function cek_simpan($id_user,$id_naker)
        {
            $query = $this->db->query("SELECT * FROM hasil_keputusan WHERE id_user='$id_user' AND hasil='$id_naker';");
            return $query->num_rows();
        }
